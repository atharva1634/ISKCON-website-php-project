      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" aria-current="page" href="/majorP2.0/contact.php">Contact Us</a>
            </li>
          </ul>
...
<div class="p-5 mb-4 bg-body-tertiary rounded-3">
      <div class="container-fluid py-5">
        ...
        <p class="col-md-8 fs-4">For free counselling contact us on the contact number given below, share your problem with us and let us help you with the solutions of Krishna's eternal wisdoms. Believe It!</p>
        <p class="btn btn-primary btn-lg" type="button">9876543210</p>
      </div>
    </div>
<footer
